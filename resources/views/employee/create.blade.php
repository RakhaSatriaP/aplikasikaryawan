            ...
            @csrf
                <div class="row">
                  ...
                  <div class="mb-3 col-md-6">
                      ...
                      <input class="form-control @error('birthday_date') is-invalid @enderror" type="date" name="birthday_date" id="birthday_date"  required/>
                      @error('birthday_date')
                        <div class="invalid-feedback">{{ $message }}</div>
                                           @enderror
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col-md-6">
                      ...
                      <input class="form-control @error('bank_number') is-invalid @enderror" type="text" id="bank_number" name="bank_number" placeholder="bank number"  required/>
                      @error('bank_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                  </div>
                ...
                <div class="row">
                  <div class="mb-3 col-md-6">
                      ...
                      {{-- <input class="form-control @error('bank') is-invalid @enderror" type="text" id="bank" name="bank" placeholder="Bank"  required/> --}}
                ...
                <div class="row">
                  <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control @error('start_date') is-invalid @enderror" type="date" id="start_date" name="start_date" placeholder="California"   required/>
                          @error('start_date')
                          <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                  </div>
                  <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control @error('end_date') is-invalid @enderror" type="date" id="end_date" name="end_date" placeholder="California"  required/>
                          @error('end_date')
                          <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <input type="text" class="form-control @error('department') is-invalid @enderror" id="department" name="department" placeholder="Department"  required/>
                    @error('department')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                  <div class="mb-3 col-md-6">
                    ...
                    <input type="number" class="form-control @error('Salary') is-invalid @enderror" id="Salary" name="Salary" placeholder="Salary"  required/>
                    @error('Salary')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
